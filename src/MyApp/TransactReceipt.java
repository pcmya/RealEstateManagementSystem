 ...
 * @author emarie
 */
public class TransactReceipt extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TransactReceipt.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("My Transaction");

        jLabel2.setFont(new java.awt.Font("Apple SD Gothic Neo", 0, 13)); // NOI18N
        jLabel2.setText("View the receipt of your transaction. Thank you for your interest in Landcaster!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TransactReceipt().setVisible(true));
    }
